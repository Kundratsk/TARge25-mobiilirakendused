...
public partial class FigurePage : ContentPage
{
 BoxView boxView;
            ...
            Points = new PointCollection
    {
        ...
        {
            // Suurendab kolmnurka praegusest väärtusest näiteks 1.2 korda suuremaks
            kolmnurk.Scale += 0.2;

            // Kui soovid seada piirangu, et liiga suureks ei läheks:
            if (kolmnurk.Scale > 3.0)
            {
                kolmnurk.Scale = 1.0; // Läheb tagasi algsuurusesse
            }
        };
    ...
    private void Liikumine(object? sender, EventArgs e)
    {
        ...
        else if (nupp.ZIndex == 3)
        {
            ...
            //nupp.Text = DateTime.Now.ToString("T");
        }
    }
}